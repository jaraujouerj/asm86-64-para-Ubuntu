...
% Place nodes
\node[doc] (init) {main.o\\$\ldots$\\\\\\\ldots\\};
\node [doc, below of=init] (objeto) {funcs.o\\$\ldots$\\\\0x0100:\\$\ldots$};
\node [doc, right of=init] (exe) {executável\\\\call 0x0400\vspace{1cm}\\\\$\ldots$\\0x0400:\\$\ldots$};
