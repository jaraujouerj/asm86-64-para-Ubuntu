...
%	\advance\leftskip+0.3cm\includegraphics[width=\linewidth]{imagens/computer}
%\end{minipage}
}
...
\fancyhf{}
\lhead{ \fancyplain{}{\chaptername} }
\rhead{ \fancyplain{}{\chaptername} }
...
\abreviatura{CISC}{Complex Instruction Set Computing}
\abreviatura{RISC}{Reduced Instruction Set Computer}
